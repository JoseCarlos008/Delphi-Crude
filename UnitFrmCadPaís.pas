...
var
  ufrmcadpais: Tufrmcadpais;

implementation

{$R *.dfm}

procedure Tufrmcadpais.tbtncancelarClick(Sender: TObject);
begin
    Self.Close;
end;

procedure Tufrmcadpais.tbtnconsultarClick(Sender: TObject);
begin
...
procedure Tufrmcadpais.tbtneditarClick(Sender: TObject);
begin
try
...
procedure Tufrmcadpais.tbtnexcluirClick(Sender: TObject);
begin
    if MessageBox(handle, 'Deseja excluir o registro?','ATENÇÃO!' , mb_YesNo ) =mrYes then
      IBTable1.Delete;
end;

procedure Tufrmcadpais.tbtnnovoClick(Sender: TObject);
begin
  IBTable1.Open;
  IBTable1.Append;
  DBEdit1.SetFocus;
...
procedure Tufrmcadpais.tbtnsalvarClick(Sender: TObject);
begin
  try
